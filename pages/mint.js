...
//
  ...
  return (
    <div id="bodyy" className="flex flex-col items-center justify-center min-h-screen py-2">
      <Head>
        <title>Boring laikas Company</title>
        <link rel="icon" href="/images/favicon.jpg" />

        <meta property="og:title" content="Boring laikas Co." key="ogtitle" />
        <meta property="og:description" content="Here at Boring laikas company, we specialise in the world's finest digital laikas. We've put together a team spanning 3 continents, to bring you some of the most ‍NUTRITIOUS and DELICIOUS
laikas out known to man." key="ogdesc" />
        <meta property="og:type" content="website" key="ogtype" />
        <meta property="og:url" content="https://boringlaikas.co/" key="ogurl"/>
        <meta property="og:image" content="https://boringlaikas.co/images/Hola.gif" key="ogimage"/>
        <meta property="og:site_name" content="https://boringlaikas.co/" key="ogsitename" />

        <meta name="twitter:card" content="summary_large_image" key="twcard"/>
        <meta property="twitter:domain" content="boringlaikas.co" key="twdomain" />
        <meta property="twitter:url" content="https://boringlaikas.co/" key="twurl" />
        <meta name="twitter:title" content="Boring laikas Co." key="twtitle" />
        <meta name="twitter:description" content="Here at boring laikas company, we specialise in the world's finest digital laikas. We've put together a team spanning 3 continents, to bring you some of the most ‍NUTRITIOUS and DELICIOUS
laikas out known to man." key="twdesc" />
        <meta name="twitter:image" content="https://boringlaikas.co/images/Hola.gif" key="twimage" />
      </Head>
        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 border-b-2 py-6">
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="flex Poppitandfinchsans text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none my-4 ">TOTAL laikaS MINTED:  <span className="text-blau text-6xl"> {!signedIn ?  <>-</>  :  <>{totalSupply}</> } / 10000</span></span>
                ...
                <div id="mint" className="flex justify-around  mt-8 mx-6">
                  ...
                  <span className="flex Poppitandfinchsans text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none px-3 font-bold">laikaS!</span>
    
                </div>
                {saleStarted ? 
                <button onClick={() => mintlaika(how_many_laikas)} className="mt-4 Poppitandfinchsans text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">MINT {how_many_laikas} laikas for {(laikaPrice * how_many_laikas) / (10 ** 18)} ETH + GAS</button>        
